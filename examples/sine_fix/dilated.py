...
def conv_net(x, cls, dropout, is_training=False):
    ...
    conv1 = GLU(xs, 4, [256, 1], scope='conv1_1', normalizer_fn=slim.batch_norm, normalizer_params={'is_training': is_training, 'decay': 0.9})
    print('conv1', conv1)

    # Parallel
    conv1_d2 = GLU(conv1, 4, [256, 1], rate=2, scope='conv1_d2')
    print('conv1_d2 ', conv1_d2)

    conv1_d4 = GLU(conv1, 4, [256, 1], rate=4, scope='conv1_d4')
    print('conv1_d4 ', conv1_d4)

    conv1 = tf.concat([conv1, conv1_d2, conv1_d4], 3)
