...
def conv_net(x, cls, dropout, is_training=False):
    ...
    #convblock 2
    conv2 = GLU(embedded, 16, [128, 1], scope='conv2_1')
    conv2 = GLU(conv2, 16, [128, 1], scope='conv2_2')
    pool2 = slim.max_pool2d(conv2, [2,1])
    print('conv2: ', pool2)

    #convblock 3
    conv3 = GLU(pool2, 32, [128, 1], scope='conv3_1')
    ...
    conv5 = GLU(conv5, 256, [64,1], scope='conv5_1')
    conv5 = GLU(conv5, 256, [3,1], scope='conv5_2')
    print('conv5: ', conv5)
